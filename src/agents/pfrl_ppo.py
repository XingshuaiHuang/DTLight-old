...
class IPPO(IndependentAgent):
    ...
    def __init__(self, config, obs_act, map_name, thread_number):
        ...
        for key in obs_act:
            ...
            self.agents[key] = PFRLPPOAgent(config, obs_space, act_space)  # redefine self.agents
...
class PFRLPPOAgent(Agent):
    def __init__(self, config, obs_space, act_space):
        ...
        self.optimizer = torch.optim.Adam(self.model.parameters(), lr=config['lr'], eps=config['eps'])
