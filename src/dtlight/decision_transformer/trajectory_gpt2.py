...
class Block(nn.Module):
    def __init__(self, n_ctx, config, scale=False):
        ...
        # self.adapter_mlp = AdapterMLP(512, config)  # TODO: ADAPTER
...
class TrajGPT2Model(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        )  # n_ctx: Dimensionality of the causal mask (usually same as n_positions)
